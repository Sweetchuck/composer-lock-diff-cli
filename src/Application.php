...
class Application extends ApplicationBase
{
    ...
    protected function initializeContainer(): static
    {
        ...
        $service = new ServiceDefinition(ConsoleTableReporter::class);
        $service->setShared(false);
        $this->container->setDefinition('composer-lock-diff.reporter.table', $service);

        $service = new ServiceDefinition(JsonReporter::class);
        $service->setShared(false);
        $this->container->setDefinition('composer-lock-diff.reporter.json', $service);
